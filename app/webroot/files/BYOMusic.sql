...
--
-- Structure de la table `bands_styles`
--

CREATE TABLE IF NOT EXISTS `bands_styles` (
  `band_id` int(11) NOT NULL,
  `style_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Contenu de la table `bands_styles`
--
...
INSERT INTO `countries` (`id`, `code`, `alpha2`, `alpha3`, `label_en`, `label_fr`) VALUES
...
(65, 226, 'GQ', 'GNQ', '1', 'Guinée Équatoriale'),
...
INSERT INTO `styles` (`id`, `label`, `description`) VALUES
(1, 'Rock', 'Rock''n roll\r\n'),
(2, 'Pop ', 'Pop music'),
(3, 'Metal', '\\m/');
